# 2210. Count Hills and Valleys in an Array.py - Python skeleton converted from C++
...
# //Similarly, an index i is part of a valley in nums if the closest non-equal neighbors 
# //of i are larger than nums[i]. Adjacent indices i and j are part of the same hill or valley 
# //if nums[i] == nums[j].
# 
