# 3047. Find the Largest Area of Square Inside Two Rectangles.py - Python skeleton converted from C++
...
# //bottomLeft[i] = [a_i, b_i] and topRight[i] = [c_i, d_i] represent the bottom-left 
